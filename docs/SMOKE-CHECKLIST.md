...
- [ ] Run `.\Scripts\Asset-Report.ps1 -IncludeSoftwareInventory` and confirm both `SoftwareInventory-<timestamp>.csv` and `FeatureInventory-<timestamp>.csv` appear in the report directory.
